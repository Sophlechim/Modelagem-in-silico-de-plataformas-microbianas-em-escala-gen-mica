...
problemaOU= RKOProblem(modeloPKDupla, fevaluation=[evaluation_1, evaluation_2], envcond=condicoes)

start_time = time.time()
ea = EA(problemaOU, max_generations=1000, visualizer=True, algorithm='SPEA2')
#print(type(ea))
final_pop=ea.run()
print(final_pop)
print(ea.dataframe())
